...
const ActiveComplain = ({ isAdmin }) => {
    ...
    useEffect(() => {
        fetch('https://rocky-waters-70556.herokuapp.com/complains?category=active', {
            method: 'POST',
